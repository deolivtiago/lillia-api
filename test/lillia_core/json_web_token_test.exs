defmodule LilliaCore.JsonWebTokenTest do
  use LilliaCore.DataCase, async: true

  import LilliaCore.Access.UserFixtures
  import LilliaCore.JsonWebTokenFixtures

  alias Ecto.Changeset
  alias LilliaCore.JsonWebToken
  ...
  describe "from_payload/1" do
    test "returns ok when payload is valid", %{user: %{id: sub}} do
      ...
      assert jwt.claims.iss == "lillia_server"
      assert jwt.claims.aud == "lillia_client"
